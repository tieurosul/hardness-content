...
namespace hardness;
/**
* Este código PHP será executado ao acessar: /est-est002-grid-est002GridAguardandoEntregaProduto/
...
*/
		...
		*/			
		$grid = array(									
			...
			array('colunaValor' => 'T006_Quantidade_Estoque', 'colunaTitulo' => 'Estoque', 'colunaAlinhar' => 'right', 'colunaCasasDecimais' => '3'),
		...
		*/
		...
		$extra = <<<EOT
			...
			WHERE T005_C004_Id='{$g['empresaAtual']}' AND T005_Flag_Status = '1'
			GROUP BY T006_Id
EOT;
