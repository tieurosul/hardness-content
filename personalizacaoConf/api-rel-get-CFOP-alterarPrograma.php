...
namespace hardness;
/**
* Este código PHP será executado ao acessar: /api-rel-get-CFOP/
...
*/
		...
		$grid = array(
			...
			array('colunaValor' => 'D006_Codigo_CFOP', 'colunaTitulo' => 'codigo_cfop'),
			array('colunaValor' => 'D006_Descricao', 'colunaTitulo' => 'descricao_cfop'),
		);
